...
export default function Home() {
  ...
  const handleFund = (amount) => {
    ...
    if (typeof window.PaystackPop === "undefined") return alert("Paystack loading, wait 2 sec")
    setLoading(true)
  ...
  return (
    <div style={{minHeight:"100vh", background:"#0f172a", color:"white", display:"flex", flexDirection:"column", alignItems:"center", padding:"20px"}}>
      ...
      <div style={{marginTop:"30px", width:"100%", maxWidth:"360px", display:"flex", flexDirection:"column", gap:"12px"}}>
        <button disabled={loading} onClick={()=>handleFund(1000)} style={{width:"100%", padding:"16px", borderRadius:"12px", fontWeight:"bold", background:"white", color:"black", border:"none"}}>Fund ₦1000 — Starter</button>
